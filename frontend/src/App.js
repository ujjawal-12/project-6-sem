...
import Registeredstudent from './component/admin/registeredsuccess';
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={token ? <Navigate to="/dashboard" replace /> : <Root />}>
            ...
            <Route path="addmission/bca/course/:name" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            <Route path="addmission/bca/course/:name" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            <Route path="addmission/bca/course/:name" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            <Route path="addmission/bca/course/:name" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            <Route path="addmission/bca/course/:name" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            ...
            <Route path="addmission/course/:cousename" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            <Route path="addmission/bca-data-analytic/course/:cousename" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            <Route path="addmission/bca/course/:cousename" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            <Route path="addmission/bca-with-research/course/:cousename" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            <Route path="addmission/bca-cyber-security/course/:cousename" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            <Route path="addmission/bsc-it-with-research/course/:cousename" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            <Route path="addmission/bsc-it/course/:cousename" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            <Route path="addmission/bsc-hons-computer-science/course/:cousename" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
            <Route path="addmission/bsc-hons-computer-science-with-research/course/:cousename" element={token ? <Applyform></Applyform> : <Navigate to="/auth/signin" replace />}></Route>
          ...
          <Route path="/dashboard" element={token ? <Root /> : <Navigate to="/" replace />}>
            {/* <Route index element={<Home />}></Route> */}
            {sessionStorage.getItem("loginusername") === "Admin" ? <Route index element={<Admin />}></Route> : <Route index element={<Home />}></Route>}
            {sessionStorage.getItem("loginusername") === "Admin" ?
              (<>
                <Route path="admin" element={<Admin></Admin>}></Route>
                <Route path="registeredstudent" element={<Registeredstudent></Registeredstudent>}></Route>
              </>)
              : (
                <>
                  ...
                  <Route path="course/:cousename" element={<Applyform></Applyform>}></Route>
