...
export const Bscit = () => {
    ...
    return (
        <div>
            ...
            <div>
                <div>
                    ...
                    <div className="d-flex justify-content-center align-items-center border border-dark">
                        ...
                        <div className="text-center border border-dark pt-4" style={{ "width": "80%", "height": "100px" }}><a href="https://drive.google.com/file/d/1XV0HTMnytbK9_jfdxCXCs9RCx2uzosH-/view?usp=sharing"> Click Here</a></div>
                    </div>
                    <div className="d-flex justify-content-center align-items-center border border-dark">
                        <div className="text-center border border-dark pt-4" style={{ "width": "20%", "height": "100px" }}>Programme Structure:</div>
                        <div className="text-center border border-dark pt-4" style={{ "width": "80%", "height": "100px" }}><a href="https://drive.google.com/file/d/19K4yPYxx5NassSr64JyEOF9Cgx4n-FLz/view?usp=sharing">Click Here</a></div>
                    </div>
                    <div className="d-flex justify-content-center align-items-center border border-dark">
            ...
            <div className="my-3">
                <button type="button" class="btn btn-primary btn-lg btn-block w-100" onClick={() => navigate("course/Bsc-it", { replace: true })}>Apply</button>
            </div>
        </div>
    )
}