...
export const BscHons = () => {
    ...
    return (
        <div>
            ...
            <div className="p-3">
                <p style={{ "color": "teal", "textAlign": "justify" }}>Computer Science offers the students a platform to explore the practical and theoretical knowledge of computation, program design, programming, computer hardware and software as well as integrates with other fields of science and engineering. Courses in the field of Computer science are being offered in other domains like Agriculture, Life Sciences, Pharmaceuticals, etc.
                </p>
                <p style={{ "color": "teal", "textAlign": "justify" }}>
                    Various technologies are heavily influencing the modern digital era. Completing your 10+2 education in the scientific stream and having a natural passion to innovate, experiment, and explore in the digital realm might lead to enrolment in B.Sc. Computer Science. Program provides all of the skills and knowledge needed to succeed and technological business. The program focuses on both practical and theoretical computer hardware and software skills. It emphasizes the fundamentals of computer programming and networking while covering a wide range of subjects.
                </p>
                <p style={{ "color": "teal", "textAlign": "justify" }}>
                    Teaching – learning pedagogy of the program put greater emphasis on the laboratory sessions to ensure hands on experience of various programming languages, software development, data analysis through statistical techniques, computer hardware and software design and development. In addition, technical workshops, seminars, guest lectures by industry experts and academicians, industrial visits are some of the unique features embedded in the curriculum of the program.
                </p>
            </div>
            <div className="p-3">
            ...
            <div className="my-3">
                <button type="button" class="btn btn-primary btn-lg btn-block w-100" onClick={() => navigate("course/Bsc-hons", { replace: true })}>Apply</button>
            </div>
        </div>
    )
}