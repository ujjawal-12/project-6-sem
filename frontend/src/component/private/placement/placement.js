...
import imgg from "../../../images/imgg.jfif"
import { placementstudent } from './placementimage'
  ...
  return (
    <div className='container-fluid mt-2'>
      {/* <div className='container-fluid m-0 p-0' >
        <img src={imgg} width="100%" height="500"></img>
      </div> */}
      <div className='container ps-3 mt-4 mb-2' >
        <p className='display-5 text-center'>Batch-2022</p>
        <div className='container ps-2 ms-5 mt-3'>
          <AliceCarousel
            mouseTracking
            items={placementstudent}
            autoPlay={true}
